// =============================================================================
// TikStream AI — Script Template Generate DTO
// =============================================================================
...
export class ScriptTemplateGenerateDto {
  @ApiProperty({
    description: '商品ID',
  ...
  @ApiProperty({
    description: '模板ID',
    example: '00000000-0000-0000-0000-000000000888',
    required: true,
  })
  @IsNotEmpty()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: '商品卖点列表（可选，缺省时使用商品自带卖点）',
  ...
  @ApiPropertyOptional({
    description: '风格氛围（可选，缺省时使用模板自带风格）',
    example: 'energetic/comparison',
  })
  @IsOptional()
  @IsString()
  style_vibe?: string;
