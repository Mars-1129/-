// =============================================================================
// TikStream AI — Hybrid Script Generation DTO
// =============================================================================

import { ApiProperty, ApiPropertyOptional } from '@nestjs/swagger';
import { IsString, IsArray, IsObject, IsBoolean, IsOptional, IsIn } from 'class-validator';
import { ValidateNested } from 'class-validator';
import { Type } from 'class-transformer';

export class GenerateHybridDto {
  ...
  @ApiPropertyOptional({ description: '用户自定义策略摘要' })
  @IsOptional()
  @IsString()
  user_strategy_summary?: string;

  @ApiPropertyOptional({ description: '用户自定义因子' })
  @IsOptional()
  @IsObject()
  user_factors?: Record<string, unknown>;

  @ApiPropertyOptional({ description: '用户自定义约束' })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({ description: '风格变化列表（多套风格）' })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
